...
def small_ds():
    return sf.dataset("synthetic", pairs=["BTCUSDT"], start="2023-01-01", end="2023-02-01", interval="1h")
...
def test_fixed_horizon_duration_string_matches_bars():
    ds_1m = sf.dataset("synthetic", pairs=["BTCUSDT"], start="2023-01-01", end="2023-01-03", interval="1m")
