...
def test_oos_backtest_reports_coverage():
    ds_fit = sf.dataset("synthetic", pairs=["BTCUSDT"], start="2023-01-01", end="2023-03-01", interval="1h")
    ds_full = sf.dataset("synthetic", pairs=["BTCUSDT"], start="2023-01-01", end="2023-04-01", interval="1h")
